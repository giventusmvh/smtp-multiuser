	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="{{ route('registrasiKonselor') }}" class="login100-form validate-form" method="POST" enctype="multipart/form-data">
                    @csrf
                   
					<span class="login100-form-title p-b-43">
						Register to continue as konselor
					</span>
					@if ($errors->any())
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Valid fullname is required">
						<input class="input100" type="text" name="fullname_konselor">
                    ...
                    <div style="margin:20px 20px 40px 20px">
                        ...
                        <input class="input100" type="file" name="gambar_konselor" id="gambar" style="margin-left:-40px;">
                    </div>
					...
					<div class="text-center p-t-46 p-b-20">
						<span class="txt2">
                            Already have an account?<a href="{{ route('auth') }}" class="text-primary"> Login</a>	
						</span>
					</div>
